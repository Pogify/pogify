...
export const Privacy = () => {
  return (
    <Layout>
        ...
        <p><a name="footnote1">1</a>: A verified session is a permanent session granted to an authenticated user</p>
        ...
        <p>Pogify.net stores user information collected from Twitch when a user authenticates using Twitch Authentication when creating a verified session<sup><a href="#footnote1">1</a></sup>. The data collected will include the users channel name. This infomation will only be stored aslong as the verified session is running</p>
        <h3 id="children-under-the-age-of-13">Children Under The Age Of 13:</h3>
        <p>Pogify.net is <strong>not</strong> intended for children under 13 years of age. We do <strong>not</strong> knowingly collect personal information from children under 13. If you are under 13, please <strong>do not</strong> provide any information on pogify.net.</p>
        <h3 id="dispute-resolution">Dispute Resolution:</h3>
        <p>If you have any complaints regarding the privacy policy please contact us at support@pogify.net. We will investigate and attempt to resolve complaints and disputes regarding the use of personal information in accordance with the privacy policy.</p>
        <p>The work on the website and the images, logos, text and other such information is the property of Pogify.net ( unless otherwise stated ).</p>
        </div>
    </Layout>
  );
};